...
export default function ReservationDetailsPage() {
    ...
    async function fetchReservation() {
      try {
        ...
        try {
          ...
          throw new Error(`پاسخ API معتبر نیست. Status: ${res.status}`);
        }

        if (!res.ok || !data.success) {
          throw new Error(data.message || "خطا در دریافت جزئیات رزرو");
        }
  ...
  return (
    <main dir="rtl" className="max-w-6xl mx-auto px-4 py-10">
      <h1 className="text-2xl font-bold mb-6">جزئیات رزرو</h1>
